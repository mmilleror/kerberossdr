...
curr_user=$(whoami)
sudo chrt -r 51 ./_receiver/C/rtl_daq 2>log_err_rtl_daq 1| sudo chrt -r 50 ./_receiver/C/sync 2>log_err_sync 1| sudo chrt -r 50 ./_receiver/C/gate 2> log_err_gate 1| python3 _GUI/hydra_main_window.py&
