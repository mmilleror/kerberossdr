...
curr_user=$(whoami)
sudo chrt -r 50 ./_receiver/C/rtl_daq $BUFF_SIZE 2>log_err_rtl_daq 1| sudo chrt -r 50 ./_receiver/C/sync $BUFF_SIZE 2>log_err_sync 1| sudo chrt -r 50 ./_receiver/C/gate $BUFF_SIZE 2> log_err_gate 1| sudo nice -n -20 sudo -u $curr_user python3 _GUI/hydra_main_window.py $BUFF_SIZE $IPADDR&
